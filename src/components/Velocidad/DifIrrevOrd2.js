...
export const DifIrrevOrd2 = () => {
  ...
  const calculate = (data) => {
    ...
    for (let i = 1; i <= index; i++) {
      ...
      k = (k / t) * -1;
      k = k / (( Math.pow(parseFloat(data["ca_" + i]), 2) + Math.pow(parseFloat(data["ca_" + j]), 2))  / 2);
      //console.log(k)
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">
          Método diferencial para una reacción no reversible de orden 2
        </h5>
