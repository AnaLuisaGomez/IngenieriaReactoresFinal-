...
export const IntIrrevOrd1 = () => {
  ...
  const calculate = (data) => {
    ...
    for (let i = 1; i <= index; i++) {
      ...
      k = Math.log(parseFloat(data["ca_0"]) / parseFloat(data["ca_" + i]));
      k = k / parseFloat(data["t_" + i]);
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">
          Método Integral para una reacción no reversible de orden 1
        </h5>
