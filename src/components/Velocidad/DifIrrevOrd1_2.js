...
export const DifIrrevOrd1_2 = () => {
  ...
  const calculate = (data) => {
    ...
    for (let i = 1; i <= index; i++) {
      ...
      k = (k / t) * -1;
      k = k / (( Math.pow(parseFloat(data["ca_" + i]), .5) + Math.pow(parseFloat(data["ca_" + j]),.5))  / 2);
      //console.log(k)
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">
          Método diferencial para una reacción no reversible de orden 1/2
        </h5>
