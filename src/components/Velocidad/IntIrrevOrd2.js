...
export const IntIrrevOrd2 = () => {
  ...
  const calculate = (data) => {
    ...
    for (let i = 1; i <= index; i++) {
      ...
      // Calculate k
      var k = new Number();
      k = (1 / parseFloat(data["ca_"+i])) - (1 / parseFloat(data["ca_0"]));
      k = k / parseInt(data['t_'+i]);
       //console.log(k)
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">
          Método Integral para una reacción no reversible de orden 2
        </h5>
